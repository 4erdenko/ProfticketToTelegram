...
LEXICON_RU: dict[str, str] = {
    ...
    'TOP_ARTISTS_REPORT': '🎭 Топ артистов по продажам билетов:',
    ...
    'TOP_SHOWS_SPEED_REPORT_TITLE': '⚡️ Топ спектаклей по скорости продаж',
    'PREDICT_SELL_OUT_REPORT_TITLE': '⏳ Спектакли, которые скоро закончатся',
    'NO_DATA_FOR_REPORT': 'Нет данных для формирования отчета за указанный период.',
    'SALES_SPEED_UNIT_PER_DAY': 'билет./день',
